...
def building_information(image_path, tolerence, actual_floor_height = 10, output_path = None):
    ...
    cv2.putText(img, f"Estimated Width : {np.round(real_width,0)} Feets", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2, cv2.LINE_AA)
    ...
    # Return the result
    return num_floors, real_height, real_width, area

# The Inference Code
if __name__ == "__main__":
    image_path = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Height_Width\images\Image_8.jpg"
    output_path = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Height_Width\images\Image_8_Result_Floor_Height_Width_Area.jpg"
