...
IMAGE_PATH = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Height_Width\Image_8.jpg"
...
height_refined, width_refined = measure_building_dimensions_with_roi(IMAGE_PATH, scale, roi_coords = REFINED_ROI, output_path = OUTPUT_PATH)
